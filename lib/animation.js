                        ...
                        const delay = i * 0.04; // Even tighter stagger for snappier feel
                            ...
                            if (lineAnimationControls[i] && lineAnimationControls[i].start) {
                                ...
                                lineAnimationControls[i].start({
                                    ...
                                    transition: {
                                        type: "spring",
                                        stiffness: 115,  // Slightly higher for quicker settling
                                        damping: 10,     // Higher damping for faster settling
                                        mass: 0.50,       // Lower mass for quicker response
                                        velocity: -1050 // Reduced velocity for controlled motion
                                    }
                                });
                            }
