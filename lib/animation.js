                        ...
                        const delay = i * 0.04; // Even tighter stagger for snappier feel
                            ...
                            if (lineAnimationControls[i] && lineAnimationControls[i].start) {
                                ...
                                lineAnimationControls[i].start({
                                    ...
                                    transition: {
                                        type: "spring",
                                        stiffness: 200,  // Lower stiffness for more overshoot
                                        damping: 60,     // Moderate damping for controlled bounce
                                        mass: 1,       // Higher mass for more momentum
                                        velocity: -1200   // Strong negative velocity creates initial downward motion
                                    }
                                });
                            }
